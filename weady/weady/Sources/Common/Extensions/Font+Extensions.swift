...
enum AppTextStyle {
    ...
    var font: Font {
        ...
        case .bodyBold16: return .custom("Pretendard-Bold", size: 16)
        ...
        case .homeRegular30: return .custom("Pretendard-Regular", size: 30)
        ...
        case .homeSemibold30: return .custom("Pretendard-SemiBold", size: 30)
        }
    }
    ...
    var lineHeight: CGFloat {
        ...
        case .headingBold20, .headingSemibold20, .headingMedium20, .headingRegular20, .headingMedium80, .metaSemibold21: return 28
    ...
    var letterSpacingPercent: CGFloat {
        switch self {
        case .bodyBold16, .bodySemibold16, .bodyMedium16, .bodyRegular16, .bodyLight16: return -1
        case .captionSemibold14, .captionMedium14, .captionRegular14, .captionLight14: return -2
        case .homeSemibold12, .homeMedium11, .homeRegular11: return -1
        default: return 0
        }
    }
}
